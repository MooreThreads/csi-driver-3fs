...
type State interface {
	...
	// UpdateVolume updates the existing 3fs volume,
	...
	// UpdateSnapshot updates the existing 3fs snapshot,
	...
	// UpdateGroupSnapshot updates the existing 3fs groupsnapshot,
